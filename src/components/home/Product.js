...
const Product = ({ product }) => {
  ...
  return (
    <div
      ...
      className="font-nunito w-full h-auto max-w-sm bg-white border border-gray-200 rounded-lg shadow ml-6 mb-7">
      <a href="#\">
      ...
      <div className="px-5 pb-5">
        ...
        <div className="flex items-center justify-evenly">
          ...
          <div className="flex items-center">
            <a href="#\" className="text-white bg-thirdColor hover:bg-fourthColor focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-md px-5 py-2.5 text-center ml-5">For detail</a>
            <button className="rounded-full w-10 h-10 bg-gray-100 p-0 border-0 inline-flex items-center justify-center text-gray-500 ml-4">
              <CiHeart size={32} />
            </button>
          </div>
        </div>
