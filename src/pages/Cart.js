    ...
    <div>
      {
        carts?.length > 0 ? <div>
          ...
          <div className="w-[450px] mt-6 h-full rounded-lg border bg-white p-6 shadow-md ml-[45rem] md:mt-0">
            
            <div class="flex justify-between">
              <p class="text-lg font-bold">Total</p>
              <div class="">
                <p class="mb-1 text-lg font-bold">${totalAmount}</p>
              </div>
            </div>
            <button class="mt-6 w-full rounded-md bg-thirdColor py-1.5 font-medium text-blue-50 hover:bg-fourthColor">Check out</button>
            <Link to="/" class="flex font-semibold text-thirdColor text-md mt-10">
              <svg class="fill-current mr-2 text-thirdColor w-4" viewBox="0 0 448 512"><path d="M134.059 296H436c6.627 0 12-5.373 12-12v-56c0-6.627-5.373-12-12-12H134.059v-46.059c0-21.382-25.851-32.09-40.971-16.971L7.029 239.029c-9.373 9.373-9.373 24.569 0 33.941l86.059 86.059c15.119 15.119 40.971 4.411 40.971-16.971V296z" /></svg>
              Continue Shopping
            </Link>
          </div>
        </div>
